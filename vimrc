...
"set rtp+=~/.local/lib/python1.7/site-packages/powerline/bindings/vim
"Window Menu
set guioptions-=m 
set guioptions-=T

map <silent> <F-1> :if &guioptions =~# 'T' <Bar>
...
"highlight cursorline cterm=Underline ctermbg=black ctermfg=NONE guibg=NONE guifg=NONE
